          ...
          <form className="space-y-4 text-gray-700 flex flex-wrap max-w-xl w-full items-center justify-center">
              ...
              <div className="w-full px-2">
                ...
                <div className="relative inline-block w-full text-gray-700">
                  <select
                    ...
                    disabled={!props.account || disable}
                  >
                    <option value={604800 * 1000}>7 day</option>
                    <option value={1209600 * 1000}>14 day</option>
                    <option value={2592000 * 1000}>30 day</option>
                  </select>
            ...
            <div className="flex items-center justify-center flex-col">
              <div className="text-pink-400">
                {isCreating && "Please wait for trasaction finish"}
              </div>
              <div className="text-pink-400">
                {isCreated &&
                  "AppID is:" + isCreated + ", share with other peoples!"}
              </div>
            </div>
          </form>
        </div>
