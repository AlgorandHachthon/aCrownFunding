...
import { donateApp, getApp, handleapps } from "../utils/algorand";
                        ...
                        {this.state.message ? (
                          ...
                          <>
                            ...
                            <p className="text-sm text-gray-500">
                              Escrow: {this.state.app.Escrow.substring(0, 12)}
                              ...
                            </p>
                            <p>
                              Create Date:{" "}
...
function Donateinput(props) {
  ...
  return (
    <div className="mt-2 flex items-end">
      ...
      <Button
        onClick={() => donateApp(props.address, props.app, Number(amount))}
      >
        Donate
      </Button>
    </div>
